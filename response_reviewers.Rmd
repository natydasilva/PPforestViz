...
\textcolor{violet}{We included a description of parallel coordinate plot in section 4 were this figure appears and the corresponding reference for further details.}
...
\textcolor{violet}{TO DO, change selection to boxplot trees}
...
\textcolor{violet}{TO DO, not sure about the solutions}
