...
\textcolor{violet}{In the discussion section we incorporate the app limitations.}
...
\textcolor{violet}{In Section 4 we have included more details and examples of use and interpreting results to address your comment.}
...
\textcolor{violet}{Formulas for all VI were defined in equations and mentioned in the text. It  is more clear now.}
...
\textcolor{violet}{ At their core Shiny widgets are mini-applications created using the shinyApp function.}
