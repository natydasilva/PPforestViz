...
However, for this potential to materialize the authors should put more emphasis on the limitations of their approach. \textcolor{violet}{TO DO}

In particular, the app focuses on the first three nodes of the trees in question, which would be much less informative in settings requiring deep trees. \textcolor{violet}{The app was modified to adress this issue. Now the user can select the nodes to see, three or more. If there are a lot of nodes will be better to select at most 4 to see better the complete display}
